...
const ZSProvider = (() => {
  ...
  // Scope to the site's composer only; skip EverLua's own injected textarea
  ...
  function truncateForSend(text) {
    ...
    const marker =
      `\n\n[…EverLua: result truncated to fit Qwen's ${SEND_CAP}-character input ` +
  ...
  // tool-calls instead of EverLua commands. Removed 2026-07: the real cause of
